...
int main(int argc, char *argv[]) {
	...
	//Your codes here
	result =0;
	if (distance>=0&& distance<=2)result=150000;
		
	if(distance>2&&distance<=30) result=15000+(distance-2)*(2000/250*1000);
	
	if(distance>30 ) result =15000+28*(2000/250*1000)+(distance-30)*5000; 
